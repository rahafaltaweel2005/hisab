              ...
              child: Column(
                ...
                children: [
                  HiasbTextField(
                    ...
                    hint: 'search'.tr(),
                    onChange: (value){
                      context.read<GetProjectsCubit>().searchProjects(value);
                    },
                    prefixIcon: Icon(
                      Icons.search,
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  fontWeight: FontWeight.w600,
                                  fontSize: 20,
                                  color: state.projects.totalReceivedAmount > 0
                                      ? ColorConst.positive
                                      : ColorConst.error,
                                ),
                              ),
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: DataTable(
                                columns: [
                                  ...
                                  DataColumn(label: Text('walletAmount'.tr())),
                                  DataColumn(label: Text('remainingAmount'.tr())),
                                ],
                                rows: [
                                  ...state.projects.projects.map((project) {
                                    return DataRow(
                                      cells: [
                                        ...
                                        DataCell(
                                          Text(
                                            project.receivedAmount.toString(),
                                            style: TextStyle(
                                              fontWeight: FontWeight.w600,
                                              fontSize: 15,
                                              color: project.receivedAmount > 0
                                                  ? ColorConst.textDark
                                                  : ColorConst.error,
                                            ),
                                          ),
                                        ...
                                        DataCell(
                                          Text(
                                            ...
                                            style: TextStyle(
                                              fontWeight: FontWeight.w600,
                                              fontSize: 15,
                                              color: project.remainingAmount > 0
                                                  ? ColorConst.positive
                                                  : ColorConst.error,
                                            ),
                                          ),
                                  ...
                                  DataRow(
                                    ...
                                    cells: [
                                      ...
                                      DataCell(
                                        Text(
                                          state.projects.totalBalance.toString(),
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                          ),
                                        ),
                                      ...
                                      DataCell(
                                        Text(
                                          state.projects.totalRemainingAmount
                                              .toString(),
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                          ),
