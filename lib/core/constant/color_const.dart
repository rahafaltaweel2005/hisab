...
class ColorConst {
  ...
  static const Color primary = Color(0xFF1B2A4E);
  static const Color secondary = Color(0xFF2E7D6B);
  static const Color tertiary = Color(0xFFC9A24B);
  ...
  static const Color neutral = Color(0xFF60626A);
  ...
  static const Color surfaceLight = Color(0xFFE4E9F4);
